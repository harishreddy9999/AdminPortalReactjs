                            ...
                            <Card className='mat-card' id="m-card">
                                ...
                                <div id="12070" className="row">
                                    <div id="12071" className="col-12 edit space d-flex justify-content-end">
                                        ...
                                        >Approve</button>
                                        {/* <button id="12073" className="btn provider-cancel-btn me-2" (click)="reject(rejectTemplate)">Reject</button>
                                        <button className="canceldismiss provider-cancel-btn me-1" id="no" (click)="dismiss()">Dismiss</button> */}
